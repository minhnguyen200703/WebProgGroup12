<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if(isset($_POST['add_product'])) {
            ...
            $file = json_decode(file_get_contents('../storage/product.json'),true);
            // Append product to array $file
            $file[] = $product;
            // Write back to json file
            file_put_contents('../storage/product.json', json_encode($file));
            ...
            <form action="vendor_add_product.php" method="post" enctype="multipart/form-data" id="add_form">
                <div class="add_container">
                    <div class="add_item">
                        ...
                        <input id="product_name" type="text" required placeholder="Please input product's name"
                            name="name" class="add_box">
                        <span class="form_field__message"></span>
                    </div>
                    <div class="add_item">
                        <span class="add_desc">Price</span>
                        <input id="product_price" type="number" required placeholder="Please input the price"
                            name="price" class="add_box">
                        <span class="form_field__message"></span>
                    </div>
                    <div class="add_item">
