            ...
            <div class="registration__right">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post"
                    ...
                    <div class="form_field">
                        ...
                        <input type="text" class="form_field__input" id="business_name" placeholder="Enter your name"
                            name="business_name">
                        <span class="form_field__message"></span>
                    </div>
                    <div class="form_field">
                        <label for="business_address" class="form_field__label">Business Address</label>
                        <input type="text" class="form_field__input" id="business_address"
                            placeholder="Enter your business address" name="business_address">
                        <span class="form_field__message"></span>
                    </div>

                    <div class="form_field">
                        <input type="submit" name="submit_btn" id="submit_btn"
                            class="form_field__label btn-hover color-2" value="Register">
                    </div>
